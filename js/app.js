...
var _ready = __webpack_require__(46);

(0, _ready.ready)(function () {
  var isHomePage = !!document.querySelector('.atf');

  if (!isHomePage) return;

  var atfSectionHeight = document.querySelector('.atf > .atf__content').offsetHeight + 10;
  var viewportHeight = document.documentElement.clientHeight - document.querySelector('.header').offsetHeight;

  if (isHomePage && atfSectionHeight > viewportHeight) {
    document.querySelector('.atf').style.height = '60rem';
  }
});
...
(0, _ready.ready)(function () {
  var commentsEl = document.querySelector('.js-disqus-toggle');
  ...
  commentsEl.addEventListener('click', function (e) {
    ...
    document.querySelector('.js-disqus-container').classList.remove('post-container--alt');
    document.querySelector('.js-disqus-comments').style.margin = '4rem';
...
(0, _ready.ready)(function () {
    var mobilePanel = document.querySelector('.mobile-header');
    ...
    var logoTrigger = document.querySelector('.js-logo-trigger');

    // Is the menu open?
    var isOpen = function isOpen() {
        return mobilePanel.classList.contains('mobile-header--open');
    };

    // Responsible for opening the nav
    var open = function open() {
        // Get height of current header
        var headerHeight = header.offsetHeight;
        // Set the "top" style for panel to slide it down
        mobilePanel.style.top = headerHeight + 'px';
        // Add classes for icon and slide-in
        mobilePanel.classList.add('mobile-header--open');
    ...
    // Responsible for closing the nav
    var close = function close() {
        // Clear the "top" style for panel to slide it down
        mobilePanel.style.top = '';
        // Remove classes for icon and slide-in
        mobilePanel.classList.remove('mobile-header--open');
...
(0, _ready.ready)(function () {
  ...
  var reviewsEl = document.querySelector(reviewsSelector);

  if (reviewsEl) {
    new Wookmark(reviewsSelector, {
      offset: 30,
      outerOffset: 0
    });
  }
...
var _scrollTo = __webpack_require__(135);
...
(0, _ready.ready)(function () {
  var callback = function callback(e) {
    ...
    setTimeout(function () {
      ...
      if (scrollTo) {
        (0, _scrollTo.scrollToY)(offset + 1, 125, 'easeInOutQuint');
      }
    }, 0);
  };

  Array.from(document.querySelectorAll('a[href^="/#"]:not(.manual-optin-trigger)')).forEach(function (e) {
...
var _fitvids = __webpack_require__(133);

var _fitvids2 = _interopRequireDefault(_fitvids);

var _domready = __webpack_require__(132);

var _domready2 = _interopRequireDefault(_domready);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log('newsssaaa'); // Required for old iPad
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(140));
